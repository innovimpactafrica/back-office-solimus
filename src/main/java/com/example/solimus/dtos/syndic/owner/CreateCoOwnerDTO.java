...
public class CreateCoOwnerDTO {
    ...
    // -------------------------------------------------------------------------
    // BIENS À AFFECTER — obligatoire à la création
    // -------------------------------------------------------------------------

    /**
     * Liste des biens à affecter au copropriétaire.
     * Chaque entrée contient une résidence + les lots sélectionnés.
     * Un copropriétaire doit avoir au moins un lot pour être considéré comme propriétaire.
     */
    @NotEmpty(message = "Au moins un bien doit être affecté au copropriétaire")
