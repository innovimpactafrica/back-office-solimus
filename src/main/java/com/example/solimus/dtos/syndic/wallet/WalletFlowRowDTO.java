...
public class WalletFlowRowDTO {
    ...
    private String beneficiaryName;   // copropriétaire (CHARGES) ou prestataire (BUDGET_EXPENSE), figé au moment de la transaction
    private String category;
    private String categoryLabel;     // "Charges" ou "Dépense budgétaire", sans suffixe de période
